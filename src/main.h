...
static const int64 DUST_SOFT_PCCIT = 100000; // 0.001 PCC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_PCCIT = 1000;   // 0.00001 PCC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 100 * COIN;
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 1440 / 250; //1440 blocks each day
    }
